...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-[100dvh] w-full overflow-hidden bg-ink font-sans text-white">
      ...
      <div className="relative z-10 mx-auto flex h-full min-h-[100dvh] max-w-[1300px] flex-col items-center px-6 pt-24 sm:px-8 sm:pt-32">
        
        {/* Hero Copy */}
        <div className="mt-8 flex flex-col items-center text-center opacity-0 animate-fade-up">
          <h1 className="flex max-w-[800px] flex-wrap justify-center items-center gap-x-4 gap-y-2 text-[42px] font-bold leading-[1.1] tracking-tight text-white sm:text-[56px] md:text-[64px]">
        ...
        <div className="mb-10 mt-10 flex items-center gap-4 z-20">
          <Link
            href="/markets"
            className="flex items-center gap-2 rounded-full bg-white px-7 py-3 text-[14px] font-bold text-ink transition hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(255,255,255,0.3)]"
          >
            Get Started
          ...
          <Link
            href="/markets"
            className="rounded-full border border-line bg-panel/60 px-7 py-3 text-[14px] font-medium text-mist backdrop-blur transition hover:-translate-y-0.5 hover:bg-line/50 hover:text-white"
          >
            Discover More
          </Link>
        </div>

        {/* Central Complex Diagram Container */}
        <div className="relative mt-2 h-[550px] w-full max-w-[1100px]">
          ...
          <div className="absolute left-[20px] top-[140px] z-10 w-[240px] rounded-[18px] border border-line bg-panel/90 p-4 shadow-xl backdrop-blur-md">
          ...
          <div className="absolute right-[20px] top-[140px] z-10 w-[240px] rounded-[18px] border border-line bg-panel/90 p-4 shadow-xl backdrop-blur-md">
            <div className="flex items-center justify-between">
          ...
          {/* Surrounding Node Hexagons */}
          <div className="absolute left-[330px] top-[70px] z-10 flex h-[90px] w-[80px] items-center justify-center [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] bg-[rgba(255,255,255,0.05)] shadow-[0_0_15px_rgba(255,255,255,0.05)] backdrop-blur-md">
          ...
          <div className="absolute left-[335px] top-[365px] z-10 flex h-[90px] w-[80px] items-center justify-center [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] bg-[rgba(255,255,255,0.05)] backdrop-blur-md">
            <div className="flex h-[86px] w-[76px] items-center justify-center [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] bg-[linear-gradient(135deg,#122b24_0%,#091512_100%)]">
          ...
          <div className="absolute right-[330px] top-[70px] z-10 flex h-[90px] w-[80px] items-center justify-center [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] bg-[rgba(255,255,255,0.05)] backdrop-blur-md">
            <div className="flex h-[86px] w-[76px] items-center justify-center [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] bg-[linear-gradient(135deg,#122b24_0%,#091512_100%)]">
          ...
          <div className="absolute right-[335px] top-[365px] z-10 flex h-[90px] w-[80px] items-center justify-center [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] bg-[rgba(255,255,255,0.05)] backdrop-blur-md">
            <div className="flex h-[86px] w-[76px] items-center justify-center [clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)] bg-[linear-gradient(135deg,#122b24_0%,#091512_100%)]">
